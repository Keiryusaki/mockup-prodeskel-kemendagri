    ...
    <div className="min-h-full bg-gradient-to-br from-white to-pd-primary-50 p-6 md:p-10 xl:p-12">
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_300px]">
        ...
        <GlassCard className="flex h-full flex-col border-strong bg-white/95 p-5">
          ...
          <a href={withBasePath('/data-prodeskel/kependudukan')} className="mt-auto inline-flex h-9 items-center justify-center gap-1 rounded-md bg-primary px-3 text-xs font-bold text-white hover:bg-primary-hover">Lihat Profil Lengkap <ArrowRight size={14} /></a>
        </GlassCard>
      </div>
    </div>
  );
